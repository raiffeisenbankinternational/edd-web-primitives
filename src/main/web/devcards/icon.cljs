(ns web.devcards.icon
  (:require
   ...
   [web.primitives.icons.core :refer [AddIcon SaveIcon DeleteIcon ClearIcon SearchIcon RefreshIcon ShareIcon MenuIcon TuneIcon CloseIcon RemoveIcon UnfoldMoreIcon UnfoldLessIcon
                                      ExpandMoreIcon ExpandLessIcon MoreHorizIcon MoreVertIcon ForwardIcon SubdirectoryArrowRightIcon CallMadeIcon DialpadIcon EventIcon
                                      ChatBubbleOutlineIcon AccountBalanceIcon AccountBalanceWalletIcon ExposureIcon AccountCircleIcon HomeOutlinedIcon NoteOutlinedIcon
                                      FormatAlignLeftOutlinedIcon StarBorderIcon PersonIcon InfoIcon SettingsIcon EditIcon ArrowRightIcon AllColapseIcon AllExpandIcon LogoIcon
                                      Level1Icon Level2Icon CheckCircleOutlineOutlinedIcon EmojiPeopleIcon
                                      DirectionsRunIcon]]))
...
(defcard-rg level2-icon "## Level2 Icon" [Level2Icon])
